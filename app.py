...
# Sample data to use in place of an API
mock_data = {
    'rodtang': {'country': 'Thailand'},
    # Add additional mock athletes as needed
}

def fetch_athlete_info(slug):
    # Using mock data as a stand-in for actual API data
    return mock_data.get(slug, {}).get('country', 'Country not found')
